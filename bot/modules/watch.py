...
def _watch(bot: Bot, update, isTar=False):
    ...
    try:
        ...
        msg += f"\n\nExample :-\n<code>/{BotCommands.WatchCommand} https://youtu.be/TcMBFSGVi1c 1080p |Avengers Endgame</code>\n\n"
        msg += "This file will be downloaded in 1080p quality and it's name will be <b>Avengers Endgame</b>"
